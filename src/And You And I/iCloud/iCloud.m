...
- (NSURL *)ubiquitousDocumentsDirectoryURL {
    ...
    // Stephan André 2015-08-02: add sub directory /data/ for my app
    documentsDirectory = [documentsDirectory URLByAppendingPathComponent:@"data"];
...
- (void)updateFiles {
    ...
    if ([self.query respondsToSelector:@selector(enumerateResultsUsingBlock:)]) {
        ...
        for (NSMetadataItem *result in queryResults) {
            //-- Stephan Andre 18.09.2015 - avoid warning -- NSURL *fileURL = [result valueForAttribute:NSMetadataItemURLKey];
...
// Stephan André 2014-04-06: add sub directory /data/ for my app
...
#pragma mark Stephan André: Fix -- remove double handler call
//            handler(nil);
...
#pragma mark Stephan André: 2014-04-06: add sub directory /evicted/ for my app
        documentsDirectory = [documentsDirectory stringByAppendingPathComponent:@"evicted"];
